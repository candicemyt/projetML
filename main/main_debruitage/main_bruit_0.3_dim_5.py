...
alltrainx_noise = alltrainx + 0.3 * np.random.normal(loc=0.0, scale=1.0, size=alltrainx.shape)
alltestx_noise = alltestx + 0.3 * np.random.normal(loc=0.0, scale=1.0, size=alltestx.shape)
